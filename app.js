...
// // Event listeners for each button to display a random string from respective arrays
...
document.getElementById("speakstorybtn").addEventListener("click", function()
{
